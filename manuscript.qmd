...
author-note:
  ...
  disclosures:
    ...
    data-sharing: Word count (excl. title page, figures, and tables) = 11,702 words.
    related-report: ~
    conflict-of-interest: ~
    financial-support: ~
    gratitude: ~
    authorship-agreements: ~
abstract: People are increasingly outsourcing professional and socio-relational tasks to artificial intelligence (AI). In six pre-registered studies with British participants (N = 3,935), we explore how and why people form negative character judgments about those who outsource tasks to AI (and humans) in different ways. We show that outsourcing makes us think more negatively about not only the person and their motivations, but also the outsourced work itself. Advancing previous work on effort, we show that the specific kind of task that people outsource matters; that reduced effort does not lead to uniformly negative character perceptions across different tasks; and that effort is important because it signals second-order judgments that people are being less authentic and care less about the task. Our research highlights the way that AI use shapes our perceptions of people, raising key philosophical questions about efficiency and authenticity in a world filled with AI-mediated interactions.
