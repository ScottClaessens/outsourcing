...
this efficiency could trade off against inferred moral character, authenticity, 
and value.

In a world where the landscape of expending effort has changed through large
language models (LLMs), we need to know how people who outsource tasks to AI 
are perceived -- and why. We know that people are increasingly using LLMs for a 
wide variety of tasks [@UKGov2024]. Due to their ubiquity and their labelled 
intention as a tool for efficiency, perhaps outsourcing to LLMs might not not 
have consequences for perceived character? We are sceptical. We know that people
dislike it when others "free ride" or reduce effort while benefiting from 
...
[@Kruger2004]. And while there is much less attention paid in social psychology
to how expending effort shapes perceptions of character, the evidence there is 
suggests that exertion of effort is deemed morally admirable and is rewarded, 
even in situations where effort does not directly generate additional product, 
quality, or economic value, suggesting that effort itself is moralized 
[@Celniker2023]. While outsourcing and reduced effort are not synonymous, it 
seems the core social psychological processes are likely to be similar: when 
someone outsources a task instead of doing it themselves, they are expending 
less effort to achieve their goal, and people value effort. Indeed, the scant 
recent work that does exist suggests that describing someone as using AI for a 
relational task led to the perception they expended less effort and were less 
satisfied with their relationship [@Liu2024] and that people receive more 
...
exchanges [e.g. @Fiske1992; @Heider1958; @Malle2022] and that what people want 
and expect from different kinds of relationships (and, therefore, associated 
tasks) varies [@Clark2012]. Indeed, from a philosophical perspective, it often 
matters not only *whether* something is done, but *how* it is done 
[@Aristotle2009; @Hursthouse2023; @Stohr2006]. An apology is not just about 
hearing someone say "I am sorry", but seeing genuine regret; a love letter is 
not just about hearing someone say "I love you", but seeing depth of emotion; 
and a bereavement letter is not just about hearing someone say "I am sorry for 
your loss", but seeing an understanding for the powerful human experience of 
loss. There is, perhaps especially for social tasks, value not only in the 
outcome of doing something, but the *process* too [@Goodman2010]. Previous work
on the role of effort, however, has seemed to suggest that effort should be 
uniformly important regardless of domain and has tended to focus on a limited 
number of tasks, looking at how people judge the quality of products like 
paintings, poems, or suits of armour based on how much effort is perceived 
[@Kruger2004] or how people judge others who expend more or less effort in 
employment and physical effort like marathon running [@Celniker2023]. Yet the 
number of tasks that people can outsource – and therefore, presumably, expend 
less effort on – is vast, and these tasks can vary in different ways that seem 
likely to have very different consequences for person perception. Different 
kinds of tasks that people can outsource can be more or less socially relevant, 
more or less consequential, and more or less likely to impact others: whether 
someone uses AI to spend less time planning a friend's birthday party or writing
an apology letter seems intuitively to be a different kind of thing than using
AI to spend less time writing a daily schedule or computer code to present a 
figure in an academic paper. To understand any potential negative effects of 
outsourcing -- to AI or to humans -- we must therefore look at a broad range of 
non-social and social tasks to understand not only potential generalizability 
but also *differences*.

Third, we need to know how different *ways* of outsourcing to AI influence 
negative perceptions. There are many different ways that people can use LLMs, 
and someone who "fully" outsources a task to AI by simply giving it a prompt and
copying the output word-for-word might be perceived very differently to someone
who gives the AI a prompt, revises the work accordingly, and finishes it 
themselves -- using AI as a *collaborative tool*, rather than as a replacement.
Similarly, someone could deceive others about their use of AI or be perfectly 
honest about it, and someone could use AI because they are in a rush or because
the task is important to them and they want to get it right. In all cases people
are expending less effort, but the way they do this is different and it remains
unclear how much this influences perceptions, and whether using AI in this way
is sufficient to eliminate negative perceptions: if someone does not do the task
fully themselves but uses an AI tool in the "best" way (by using it as a 
collaborative tool, being open about their use of AI, and having a good reason 
for using AI), would they still suffer negative social consequences from doing 
so?

Fourth, we need to understand *why* outsourcing to AI, and therefore expending 
less effort, might have these effects. Why is it that delegating to an AI might
have negative consequences for person perception – especially if people are, in
one sense, only using the AI tool in the precise way it has been designed and 
marketed? Previous work has focused on how expending less effort directly leads
to negative perceptions of others [@Celniker2023]. But this raises the question
of *why* effort is seen as important and what exactly it is signalling to
others, beyond one's general cooperative intent. It is possible that outsourcing
leads to negative perceptions because the lack of effort spent on the task
signals something more fundamental about how authentic one is and how much one
cares about the task: when someone chooses to outsource a love letter to an AI,
they might be seen as valuing that love letter and what it represents less. It
could be this second-step order of perceptions that is the key driver of
negative perceptions, and this, in turn, could especially be so for the kinds of
tasks that are more socially relevant.

## Present Research

In this paper, we explore how people perceive others who outsource different 
kinds of tasks, in different ways, for different reasons, to AI. Across six 
pre-registered experiments with British participants, we seek not only to 
understand how reduced effort through AI-outsourcing might shape perceptions of 
others, but also advance previous theoretical work on the moralization of effort
[@Celniker2023]. Moving beyond a focus on how effort itself shapes character 
judgments uniformly across different domains, we seek to provide deeper 
theoretical nuance into why effort is important: that effort might be 
particularly important for socio-relational tasks, not only because effort 
itself is intrinsically moralized, but because expending effort gives rise to 
second-order inferences that independently influence character judgments about
...
of outsourcing on negative character evaluations, but it could also suggest that
even using an personalized LLM still does not make someone truly authentic, in
the same way that we found even people who are honest and used AI as a tool are
still judged negatively for social tasks particularly. That is, while the 
majority of participants in our study stated that the personalized AI was more 
authentic than a standard model like ChatGPT, using a personalized LLM is still
not meaningfully authentic because of its nature: that this is a feature of the
phenomenon, not a bug. An AI could be perfectly trained on all apologies that a 
person has ever written, but one might still think that a specific apology it 
then generates in a new instance is not an *authentic* apology because it does 
not come from the kind of processes deemed important in an apology: a personal 
recollection of the wrong, a commitment to change. An apology written by an AI, 
even in someone's own style, is still arguably not an actual apology.
...
There is an apparent paradox of effort: it is both costly and valued [see 
@Inzlicht2018]. While seemingly critical to our social lives, though, there has 
been relatively little attention paid to how (not) expending effort shapes how 
we are viewed by others. @Celniker2023 argue that effort is moralized because 
people seem to infer positive moral character and cooperative intent from 
effort. Yet this work has looked only at a few types of cases where effort is 
expended or people seek outside help, where these are not necessarily the most 
socially impactful: looking at how people judge the quality of products like 
paintings, poems, or suits of armor based on how much effort is perceived 
[@Kruger2004] or looking at how people judge others who expend more or less 
effort in employment and physical exercise [@Celniker2023] or, in the context of
AI, those who use AI for work [@Reif2025]. It has remained unclear how we might
view others who outsource to AI specifically; how these effects might vary based
on how socio-relational the task is; how different ways of outsourcing and 
expending less effort influence perceptions; and how outsourcing has different
effects on different kinds of social perceptions. And perhaps most importantly,
through asking these questions, we gain insight into the most important
question: why exactly does effort have the effects that it does? Why do people
care not only about the outcome achieved but the process by which it is done,
and why might outsourcing to AI (or humans) trade off efficiency for inferred
authenticity, care, and moral character? Is it that expending less effort 
directly leads to negative social perceptions, as some have argued in psychology 
