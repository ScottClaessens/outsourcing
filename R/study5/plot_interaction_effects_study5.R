# function to plot interaction effects for study 5
plot_interaction_effects_study5 <- function(combined_interaction_effects_study5) {
  ...
  # save
  ggsave(
    filename = "plots/study5_interactions.pdf",
    plot = out,
    height = 6,
    width = 7
  )
