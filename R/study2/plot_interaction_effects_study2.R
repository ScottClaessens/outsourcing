# function to plot interaction effects for study 2
plot_interaction_effects_study2 <- function(combined_interaction_effects_study2) {
  ...
  # save
  ggsave(
    filename = "plots/study2_interactions.pdf",
    plot = out,
    height = 6,
    width = 7
  )
