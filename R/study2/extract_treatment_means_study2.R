# function to extract treatment means from model 1 in study 2
extract_treatment_means_study2 <- function(study2_fit1) {
  # function to extract treatment means for specific response variable
  extract_fun <- function(resp) {
    # new data
    d <- tibble(treatment = c("Control", "AI_Tool_Honest", "AI_Tool_Deception",
